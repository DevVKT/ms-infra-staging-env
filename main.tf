...
module "aws-network" {
  source = "github.com/devVKT/module-aws-network"

  env_name              = local.env_name
  vpc_name              = "vkt-staging-VPC"
...
module "aws-kubernetes-cluster" {
  source = "github.com/devVKT/module-aws-kubernetes"
...
module "argo-cd-server" {
  source = "github.com/devVKT/module-argo-cd"
...
module "aws-databases" {
  source = "github.com/devVKT/ms-aws-db"
...
# Create Traefik
module "traefik" {
  source = "github.com/devVKT/ms-traefik"
